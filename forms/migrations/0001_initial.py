# Generated by Django 4.2.4 on 2025-10-07 20:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('countryOfResidence', models.CharField(blank=True, max_length=500)),
                ('cityOfResidence', models.CharField(blank=True, max_length=500)),
                ('birthDate', models.DateField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cityOfResidence', models.CharField(blank=True, max_length=500)),
                ('companyName', models.CharField(blank=True, max_length=500)),
                ('websiteAddress', models.URLField(blank=True, max_length=500)),
                ('linkedinAddress', models.URLField(blank=True, max_length=500)),
                ('briefIntroduction', models.TextField(blank=True, max_length=500)),
                ('howDidYouKnowUs', models.CharField(blank=True, max_length=500)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('updatedAt', models.DateTimeField(auto_now=True)),
            ],
