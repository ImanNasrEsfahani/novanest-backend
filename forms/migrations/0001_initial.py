# Generated by Django 4.2.4 on 2025-10-03 18:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TypeOfCollaboration', models.CharField(blank=True, max_length=10)),
                ('FieldOfExpert', models.CharField(blank=True, max_length=10)),
                ('birthDate', models.DateField(blank=True)),
                ('educationLevel', models.CharField(blank=True, max_length=50)),
                ('educationField', models.CharField(blank=True, max_length=300)),
                ('workHistorySummary', models.CharField(blank=True, max_length=1500)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('updatedAt', models.DateTimeField(auto_now=True)),
            ],
        ),
